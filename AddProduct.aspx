       ...
       <div class ="form-horizontal">
           ...
           <div class ="form-group">
               ...
               <div class ="col-md-3">
                   <asp:TextBox ID="txtProductName" CssClass ="form-control" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorProductName" runat="server" CssClass ="text-danger " ErrorMessage="*plz Enter Proudct Name" ControlToValidate="txtProductName" ForeColor="Red"></asp:RequiredFieldValidator>
           ...
           <div class ="form-group">
               ...
               <div class ="col-md-3">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorPrice" runat="server" CssClass ="text-danger " ErrorMessage="*plz Enter Price" ControlToValidate="txtPrice" ForeColor="Red"></asp:RequiredFieldValidator>
           ...
           <div class ="form-group">
               ...
               <div class ="col-md-3">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorSellingPrice" runat="server" CssClass ="text-danger " ErrorMessage="*plz Enter SellingPrice" ControlToValidate="txtsellPrice" ForeColor="Red"></asp:RequiredFieldValidator>
           ...
           <div class ="form-group">
               ...
               <div class ="col-md-3">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorQuantity" runat="server" CssClass ="text-danger " ErrorMessage="*plz Enter Quantity" ControlToValidate="txtQuantity" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            <div class ="form-group">
               ...
               <div class ="col-md-3">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorDescription" runat="server" CssClass ="text-danger " ErrorMessage="*plz Enter Description" ControlToValidate="txtDescription" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            <div class ="form-group">
               ...
               <div class ="col-md-3">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorProductDetails" runat="server" CssClass ="text-danger " ErrorMessage="*plz Enter Product Detail" ControlToValidate="txtPDetail" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            <div class ="form-group">
               ...
               <div class ="col-md-3">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidatorMaterialsandCare" runat="server" CssClass ="text-danger " ErrorMessage="*plz Enter Materials and Care" ControlToValidate="txtMatCare" ForeColor="Red"></asp:RequiredFieldValidator>
           ...
           <div class ="form-group">
            ...
            <div class ="form-group">
               <asp:Label ID="Label21" runat="server" CssClass ="col-md-2 control-label" Text="Upload Image"></asp:Label>
               <div class ="col-md-3">
            ...
            <div class ="form-group">
               <asp:Label ID="Label22" runat="server" CssClass ="col-md-2 control-label" Text="Upload Image"></asp:Label>
               <div class ="col-md-3">
            ...
            <div class ="form-group">
               <asp:Label ID="Label23" runat="server" CssClass ="col-md-2 control-label" Text="Upload Image"></asp:Label>
               <div class ="col-md-3">
                   <asp:FileUpload ID="fuImg09" CssClass ="form-control" runat="server" />
               </div>
           </div>
            
             <div class ="form-group">
               <asp:Label ID="Label24" runat="server" CssClass ="col-md-2 control-label" Text="Upload Image"></asp:Label>
               <div class ="col-md-3">
                   <asp:FileUpload ID="fuImg10" CssClass ="form-control" runat="server" />
               </div>
           </div>--%>
